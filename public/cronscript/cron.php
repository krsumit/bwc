            ...
            while ($articleRow = $articleResults->fetch_assoc()) {
                ...
                if ($checkArticleResult->num_rows > 0) {
                    ...
                    if ($articleRow['status'] == 'P') {
                        ...
                        $articleUpdateStmt->bind_param('sssisssiiiiiissssssiiiiii', $articleRow['title'], $articleRow['description'], $articleRow['summary'], $articleRow['news_type']
                    ...
                    if ($articleRow['status'] == 'P') {
                        ...
                        $articleInsertStmt->bind_param('isssisssiiiiiissssssiiiiii', $articleRow['article_id'], $articleRow['title'], $articleRow['description'], $articleRow['summary'], $articleRow['news_type']
