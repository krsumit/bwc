...
class Guard implements GuardContract
{
                                ...
                                Request $request = null)
    {
        ...
        //fwrite($asd,$session->get('id')."INside GUARD contructerrrr with session/request/provider SSSSS \n");
        //fclose($asd);
    ...
    public function user()
    {
        ...
        //$asd = fopen("/home/sudipta/log.log", 'a+');
        //fwrite($asd,$id." 1 GUARD.PHP USER ");
        //fclose($asd);
        ...
        //$asd = fopen("/home/sudipta/log.log", 'a+');
        //fwrite($asd,"\n\n One: ".$user." Two".$recaller." GUARD.PHP Check Current User is authenticated. Yes. CHECK BOTH >>> \n\n");
        //fclose($asd);
    ...
    {
        return $this->attempt($credentials, true, false);
    }
    ...
    protected function clearUserDataFromStorage()
    {
        ...
        //$asd=fopen("/home/sudipta/log.log",'a+');
        //fwrite($asd,"33333333333".$recaller." \n");
        //fclose($asd);
            //--Code added Self - Mugdha
        Cookie::forget($recaller);
        Cookie::forget('laravel_session');
        Cookie::forget('XSRF-TOKEN');
            //--Code added Self - Mugdha
        
        //Response::make('foo')->withCookie($recaller);
    ...
    {
        //$asd=fopen("/home/sudipta/log.log",'a+');
        //fwrite($asd,"INside setcookieJar 1 GUARD.PHP CCCCC \n");
        //fclose($asd);
        $this->cookie = $cookie;
    }
    ...
    {
        //$asd=fopen("/home/sudipta/log.log",'a+');
        //fwrite($asd," Inside GAUFD SETTING USER \n");
        //fclose($asd);
        $this->user = $user;
    ...
    {
        //$asd = fopen("/home/sudipta/log.log", 'a+');
        //fwrite($asd, 'login_'.md5(get_class($this))." GET NAME-- SSSSS \n");
        //fwrite($asd,"\n clss Name encrypted ". get_class($this)." GET NAME-- SSSSS \n");
        //fclose($asd);
