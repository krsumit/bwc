...
@section('title', 'Newsletters- BWCMS')
                ...
                $("#channel_sel").change(function () {
                    $(this).find("option:selected").each(function () {
                        ...
                        if ($(this).attr("value").trim().length != 0) {
                            ...
                            window.location = '{{url("newsletter")}}' + '?channel=' + $(this).attr("value").trim();
                        }
                    ...
                    <table class="table table-striped" id="tableSortable">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX"  id="rowCur{{$newsletter->id}}">
                                <td><a href="/newsletter/manage/{{ $newsletter->id }}">{{ $newsletter->id }}</a> </td>
                                <td><a href="/newsletter/manage/{{ $newsletter->id }}">{{ $newsletter->title }}</td>
                                <td>
            ...
            <script>
                ...
                function deleteArticle() {
                    ...
                    if (checkedVals.length > 0) {
                        ...
                        $.get("{{ url('/newsletter/deletens/?channel=').$currentChannelId}}",
                                {option: ids},
                        function (data) {
