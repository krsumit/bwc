...
@section('title', 'Add Event Streaming - BWCMS')
@section('content')
<div class="panel">
    <div class="panel-content filler">
        <div class="panel-logo"></div>
        <div class="panel-header">
            <h1><small>Add Event Streaming</small></h1>
        </div>
        <script>
...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li class="current">
                <a href="javascript:;">Add Event Streaming</a>
            </li>
        </ul>
    </div>           <header>
        <i class="icon-big-notepad"></i>
        <h2><small>Add Event Streaming</small></h2>

    </header>
    {!! Form::open(array('url'=>'event/streaming','class'=> 'form-horizontal','id'=>'speaker-form','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}
    @if (count($errors) > 0)
    ...
    <div class="container-fluid">
        ...
        <div id="Text_Area_-_No_Resize" class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <textarea rows="4" name="embed_code" id="embed_code" class="no-resize"></textarea>
                </div>
            </div>
        </div>
        <label class="" >
            <input type="checkbox" name="is_live" id="is_live" class="uniformCheckbox2" value="1">
