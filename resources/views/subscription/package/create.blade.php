...
@section('title', 'Create Subscription Packages - BWCMS')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small> Add subscription package </small></h1>
        </div>
...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li>
                ...
                <ul class="breadcrumb-sub-nav">
                    <li>
                        <a href="#">Add Subscription Package</a>
                    </li>
        ...
        <h2><small>Add Subscription Package</small></h2>
        <h3><small>{{ $userTup->name or '' }}</small></h3>
    </header>
    {!! Form::open(array('url'=>'subscription/packages','class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}
                ...
                <div class="controls">
                    <select name="freebies[]" id="freebies" class="formattedelement" multiple="multiple">
							   ...
							   @foreach($freebies as $freebie)
										 <option value="{{$freebie->id}}">{{substr($freebie->description,0,50)}}</option>
							   @endforeach
                    </select>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" name="price[{{$magazine->channel_id}}]" value=""/>
                </div>
            </div>
        </div>
        @endforeach
