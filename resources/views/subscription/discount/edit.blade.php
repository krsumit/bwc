...
@section('title', 'Edit Subscription Discounts - BWCMS')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small> Edit subscription Discounts </small></h1>
        </div>
...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li>
                ...
                <ul class="breadcrumb-sub-nav">
                    <li>
                        <a href="#">Edit Subscription Discount</a>
                    </li>
        ...
        <h2><small>Edit Subscription Discount</small></h2>
        <h3><small>{{ $userTup->name or '' }}</small></h3>
    </header>
    {!! Form::open(array('url'=>'subscription/discounts/update','class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}
    <input type="hidden" name="discount_id" value="{{$discountDetail->id}}"/>
    ...
    <div class="container-fluid">
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" name="no_of_magazine" value="{{$discountDetail->no_of_magazine}}"/>
                </div>
            ...
            <div class="span9">
                <div class="controls">
                    <select name="discount_type" id="discount_type" class="formattedelement">
							   <option value="1" @if($discountDetail->discount_type==1) selected="selected" @endif>Percent</option>
                        <option value="2" @if($discountDetail->discount_type==2) selected="selected" @endif>Fixed</option>
                    </select>
                </div>
        ...
        <!--Text Area - No Resize end-->
		  <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" name="discount" value="{{$discountDetail->discount}}"/>
                </div>
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                                       ...
                                       Inactive<input type="radio" name="status" value="0" style="margin:15px" @if($discountDetail->status==0) checked @endif />
                                       Active <input type="radio" name="status" style="margin:15px"  value="1" @if($discountDetail->status==1) checked @endif />
                </div>
            </div>
        </div>
