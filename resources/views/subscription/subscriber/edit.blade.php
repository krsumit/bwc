...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small> Edit Subscriber </small></h1>
        </div>
...
<div class="main-content">
    <div class="breadcrumb-container">
        ...
        <h2><small>Edit Subscriber</small></h2>
        <h3><small>{{ $userTup->name or '' }}</small></h3>
    </header>
    {!! Form::open(array('url'=>'subscribers/update','class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}
    ...
    <div class="container-fluid" id="subscriber-detail-section">
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" name="email" id="email" value="{{old('email')?:$subscriber->email}}">
                </div>
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" name="mobile" id="mobile" value="{{old('mobile')?:$subscriber->mobile}}">
                </div>
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" name="dob" id="datepicker" class="span3" value="{{old('dob')?:$subscriber->dob}}" />
                </div>
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    {{--*/ $sex = old('sex')?:$subscriber->sex /*--}}
                    Male<input type="radio" name="sex" value="1" style="margin:15px" @if($sex=='1') checked @endif />
                    Female <input type="radio" name="sex" style="margin:15px"  value="2" @if($sex=='2') checked @endif/>
                    Other <input type="radio" name="sex" style="margin:15px"  value="3" @if($sex=='3') checked @endif/>
                </div>
    ...
    <div class="container-fluid" id="address-section">
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" name="address1" id="address1" value="{{old('address1')?:$subscriber->address1}}">
                </div>
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" name="address2" id="address2" value="{{old('address2')?:$subscriber->address2}}">
                </div>
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" name="city" id="city" value="{{old('city')?:$subscriber->city}}">
                </div>
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    {{--*/ $countryId = old('country')?:$subscriber->country /*--}}
                    <select name="country" id="selectBoxFilter6">
                        <option  value="">Please Select</option>
                        @foreach($country as $country)
                        <option value="{{ $country->country_id }}" @if($country->country_id==$countryId) selected="selected" @endif>{{ $country->name }}</option>
                        @endforeach	                                        
                    </select>
                </div>
        ...
        <div id="tabState" class="control-group row-fluid">
            <div id="Simple_Select_Box_with_Filter_Search" class="control-group row-fluid">
                ...
                <div class="span9" >
                    <div class="controls">
                        {{--*/ $stateId = old('state')?:$subscriber->state /*--}}
                        <select name="state" id="selectBoxFilter7">
                            <option value="">Please Select</option>
                            @foreach($states as $state)
                            <option value="{{ $state->state_id}}" @if($state->state_id==$stateId) selected="selected" @endif>{{ $state->name }}</option>		
                            @endforeach
                        </select>
                    </div>
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" name="pin" id="pin" class="span3" value="{{old('zip')?:$subscriber->zip}}">
                </div>
