...
@section('title', 'Subscriber  list- BWCMS')
    ...
    <div class="panel-content filler">
        ...
        <div class="panel-search container-fluid">
            <form class="form-horizontal" method="get" action="">
                ...
                <a href="{{url("subscribers")}}"><button class="btn btn-default" type="button">Reset</button></a>
                @endif
            </form>
        </div>
...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li class="current">
                <a href="javascript:;">Subscriber list</a>
            </li>
        </ul>
    </div>           <header>
        <i class="icon-big-notepad"></i>
        <h2><small>Subscribers list</small></h2>
    </header>
    ...
    <form class="form-horizontal">
                    ...
                    <table class="table table-striped" id="tableSortable">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX"  id="rowCur{{$subscriber->id}}">
                                ...
                                <td><a href="/subscriptions/user/{{$subscriber->id}}"><button class="btn btn-default" type="button">Orders</button></a></td>
                                <td class="center">
        ...
        <div class="control-group row-fluid">
            <div class="span12 span-inset">
                <button type="button" class="btn btn-danger" onclick="deleteSubscriber()">Dump</button><img src="images/photon/preloader/76.gif" alt="loader" style="width:5%; display:none;"/>
            </div>
        </div>
    </form>
</div>
