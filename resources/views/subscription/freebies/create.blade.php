...
@section('title', 'Create Subscription Freebies - BWCMS')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small> Add subscription Freebies </small></h1>
        </div>
...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li>
                ...
                <ul class="breadcrumb-sub-nav">
                    <li>
                        <a href="#">Add Subscription Freebies</a>
                    </li>
        ...
        <h2><small>Add Subscription Freebies</small></h2>
        <h3><small>{{ $userTup->name or '' }}</small></h3>
    </header>
    {!! Form::open(array('url'=>'subscription/freebies','class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}
