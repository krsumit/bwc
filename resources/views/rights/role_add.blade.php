...
<div class="main-content">
    <div class="breadcrumb-container">
        ...
        <h2><small> Add Role </small></h2>

    </header>
    {!! Form::open(array('url'=>'roles/store/','class'=> 'form-horizontal','id'=>'form1')) !!}
    {!! csrf_field() !!}
    ...
    <div class="container-fluid">
        ...
        <div class="form-legend" >Add Role</div>
        ...
        <div class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input id="inputField" name="name" type="text" value="">
                </div>
            </div>
        </div>
    </div>
