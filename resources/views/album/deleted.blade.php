...
@section('title', 'Deleted Album - BWCMS')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small>Deleted Album</small></h1>
        </div>
        <div class="panel-search container-fluid" style="height: 100px">
            <form class="form-horizontal" method="get" action="">
                ...
                <a href="{{url("album/list/deleted?channel=").$currentChannelId}}"><button class="btn btn-default" type="button">Reset</button></a>
                @endif
...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li class="current">
                <a href="javascript:;">Deleted Album</a>
            </li>
        </ul>
    </div>           <header>
        <i class="icon-big-notepad"></i>
        <h2><small>Deleted Album</small></h2>
    ...
    {!! Form::open(array('url'=>'album/','class'=> 'form-horizontal','id'=>'validation_form')) !!}
    {!! csrf_field() !!}
    ...
    <div class="control-group row-fluid">
        <div class="span12 span-inset">
            <button type="button" onclick="publishAlbum()" class="btn btn-success">Publish</button><img src="{{ asset('images/photon/preloader/76.gif')}}" alt="loader" style="width:5%; display:none;"/>
        </div>
    </div>
    {!! Form::close() !!}
</div>
