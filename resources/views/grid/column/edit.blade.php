...
@section('title', 'Edit Grid Column- BWCMS')
@section('content')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small>Edit Grid Column</small></h1>
        </div>
...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li>
                <a href="/gird-columns/{{$grid->id}}">Grid Column</a>

            </li>
            <li class="current">
                <a href="javascript:;">Edit Grid Column</a>
            </li>
        </ul>
    </div>            <header>
        <i class="icon-big-notepad"></i>
        <h2><small>Edit Grid Column</small></h2>
    </header>
    ...
    {!! Form::open(array('url'=>'grid-columns/'.$column->id,'class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}
    {!! method_field('PUT') !!}
<!--    <input type="hidden" name="brand_id" id="brand_id" value=""/>-->
    ...
    <div class="container-fluid">
        ...
        <div  class="control-group row-fluid">
            <div class="span3">
                <label class="control-label" for="title">Column Name</label>
            </div>
            <div class="span9">
                <div class="controls">
                    <input type="text" id="column_name" name="column_name" required="required" value="{{ old('column_name')?old('column_name'):$column->name }}"/>
            </div>
            </div>
        </div>
            ...
            <div class="span9">
                <div class="controls">
                   <select name="product_type" id="product_type" >
                        ...
                        <option value="{{ $productType->id }}" @if($productType->id==$attGroup->product_type_id) selected="selected" @endif>{{ $productType->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="span9">
                <div class="controls">
                    <select name="attribute_group" id="attribute_group" >
                        ...
                        <option value="{{ $group->id }}" @if($group->id==$attGroup->id) selected="selected" @endif>{{ $group->name }}</option>
                        @endforeach
                    </select>
                </div>
                 <script>
