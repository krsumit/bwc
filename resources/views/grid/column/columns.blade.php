...
@section('title', 'Grid Columns - BWCMS')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small>Grid Columns</small></h1>
        ...
        <div class="panel-search container-fluid">
            <form class="form-horizontal" method="get" action="">
                ...
                <a href="/grid-columns/{{$grid->id}}"><button class="btn btn-default" type="button">Reset</button></a>
                @endif
...
<div class="main-content">
    <div class="breadcrumb-container">
        ...
        <h2><small>Grid Columns</small></h2>
    </header>
   <div style="margin-bottom:20px;margin-right:20px;text-align:right;">
        <a href="/grid-columns/create?grid={{$grid->id}}" >
            <button class="btn btn-default" id="draftSubmit" value="S" name="status" type="submit">Create Column</button>
        </a>
    </div>
        ...
        @if(count($columns)>0)
            {!! Form::open(array('url'=>'/grid-columns/'.$grid->id,'class'=> 'form-horizontal','id'=>'brands_list_from','enctype'=>'multipart/form-data')) !!}
            {!! csrf_field() !!}
            {!! method_field('DELETE') !!}  
            <div class="container-fluid">
                        ...
                        <table class="table table-striped" id="tableSortable">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX" id="rowCur{{$column->id}}">
                                    ...
                                    <td class="center"> 
                                       <input type="checkbox" class="uniformCheckbox" value="{{$column->id}}" name="checkItem[]"> 
                                    </td>
            ...
            <div class="control-group row-fluid">
                <div class="span12 span-inset">
                    <button type="button" onclick="deleteColumn()" class="btn btn-danger">Dump</button><img src="images/photon/preloader/76.gif" alt="loader" style="width:5%; display:none;"/>							
                </div>
            </div>
            {!! Form::close() !!}
        @else
