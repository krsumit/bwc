    ...
    <div class="panel-content filler">
		...
		<div class="panel-search container-fluid">
            <form class="form-horizontal" method="get" action="">
                    ...
                    <a href="/sub-category-master/add/?name={{$_GET['name'] or ''}}&id={{$_GET['id'] or ''}}"><button class="btn btn-default" type="button">Reset</button></a>
                    @endif
  ...
  <!--Topics begin-->
				...
				<div  class="control-group row-fluid">
                       ...
                       <div class="control-group row-fluid">
                           ...
                           <input type="hidden" value="{{$_GET['name'] or ''}}"  name="p_name">
                           <input type="hidden" value="secondsubcategory" id="secondsubcategory" name="secondsubcategory">
                            <input type="hidden" value="{{$_GET['id'] or ''}}" id="p_id" name="p_id">
                            <div class="span9">
                                <div class="controls">
...
<div class="row-fluid">
                           <div class="span12">
                               <table class="table table-striped" id="tableSortable">
                                   ...
                                   <tbody>
                                       @foreach($posts as $a)
                                        <tr id="rowCur{{$a->category_two_id}}">
                                           <td>{{$a->category_two_id}}</td>
                                           <td><a href="/sub-category_second_master/add/?name={{$a->name}}&id={{$a->category_two_id}}">{{$a->name}}</a></td>
                                           <td>{{$a->userssname}}</td>
                                           <td>{{$a->created_at}}</td>
                                           <td><a href="/category/edit/{{$a->category_two_id}}?level=2">Edit</a></td>
                                          <td><input type="checkbox" class="uniformCheckbox" value="{{$a->category_two_id}}" name="checkItem[]"></td>
                                       </tr>
                                       @endforeach
