		...
		<div class="panel-search container-fluid">
            <form class="form-horizontal" method="get" action="">
                    ...
                    <button class="btn btn-search" type="submit"></button>
                     ...
                     <a href="/sub-category_second_master/add/?name={{$_GET['name'] or ''}}&id={{$_GET['id'] or ''}}"><button class="btn btn-default" type="button">Reset</button></a>
                   @endif
  ...
  <!--Topics begin-->
				...
				<div  class="control-group row-fluid">
                       ...
                       <div class="control-group row-fluid">
                           ...
                           <input type="hidden" value="{{$_GET['name'] or ''}}"  name="ps_name">
                           <input type="hidden" value="thridsubcategory" id="thridsubcategory" name="thridsubcategory">
                            <input type="hidden" value="{{$_GET['id'] or ''}}" id="ps_id" name="ps_id">
                            <div class="span9">
                                <div class="controls">
...
<div class="row-fluid">
                           <div class="span12">
                               <table class="table table-striped" id="tableSortable">
                                   ...
                                   <tbody>
                                       @foreach($posts as $a)
                                        <tr id="rowCur{{$a->category_three_id}}">
                                           <td>{{$a->category_three_id}}</td>
