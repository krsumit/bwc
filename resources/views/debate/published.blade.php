...
@section('title', 'Published Debate - BWCMS')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small>Published Debate</small></h1>
        </div>
        <div class="panel-search container-fluid" style="height: 100px">
            <form class="form-horizontal" action="">
                ...
                <label class="radio">
                    <input type="radio" checked="checked"  @if(isset($_GET['searchin'])) @if($_GET['searchin']=='title') checked @endif @endif required name="searchin" class="uniformRadio" value="title">
...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li class="current">
                <a href="javascript:;">Published Debate</a>
            </li>
        </ul>
    </div>           <header>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <table class="table table-striped table-responsive" id="tableSortableResMed">
                        ...
                        <tbody>
                            @foreach($debates as $db) <?php //print_r($db); exit; ?>
                            <?php //echo '<pre>'; print_r($qb);exit;  ?>
                            <tr class="gradeX" id="rowCur{{$db->id}}">
                                <td>{{$db->id}}<a href="javascript:;" class="bootstrap-tooltip" data-placement="top" data-original-title="No. of Photos"><i class="icon-photon info-circle"></i></a></td>
                                
                                <td><a href="/debate/edit/{{$db->id}}">{{$db->title}}</a></td>
                                <td>{{$db->created_at}}</td>
                                <td class="center"><input type="checkbox" name="checkItem[]" class="uniformCheckbox" value="{{$db->id}}"></td>
                            </tr>
                            @endforeach
<!--                            <tr class="gradeX">
            ...
            <div class="dataTables_paginate paging_bootstrap pagination">
                ...
                {!! $debates->appends(Input::get())->render() !!}
            </div>
        </div><!-- end container -->
        <script>
