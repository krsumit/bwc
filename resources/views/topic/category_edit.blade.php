...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small>Edit Topic Category</small></h1>
        </div>
...
<div class="main-content">
    <div class="breadcrumb-container">
        ...
        <h2><small>Edit Topic Category</small></h2>
    </header>
    {!! Form::open(array('url'=>'article/category/update/','class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    ...
                    <input type="text" id="title" name="title" value="{{$category->name}}"/>
                </div>
            </div>
        </div>
