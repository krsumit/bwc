...
@section('title', 'Create Topic  - BWCMS')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small>Create Topic </small></h1>
        </div>
...
<div class="main-content">
    ...
    {!! Form::open(array('url'=>'topics/update','class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    ...
                    <input type="text" id="title" name="title" value="{{$topic->topic}}"/>
                </div>
            </div>
        </div>
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <select name="category" id="category" class="formattedelement">
                        ...
                        <option value="{{ $cat->id }}" @if($cat->id==$topic->category_id) selected="selected" @endif>{{ $cat->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
