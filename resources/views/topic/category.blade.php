...
@section('title', 'Topic Category list- BWCMS')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small>Topic category</small></h1>
        ...
        <div class="panel-search container-fluid">
            <form class="form-horizontal" method="get" action="">
                ...
                <a href="{{url("topic/category/list")}}"><button class="btn btn-default" type="button">Reset</button></a>
                @endif
            </form>
        </div>
...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li class="current">
                <a href="javascript:;">Topic Category list</a>
            </li>
        </ul>
    </div>           <header>
        <i class="icon-big-notepad"></i>
        <h2><small>Topic Category list</small></h2>
    </header>
    <div style="margin-bottom:20px;margin-right:20px;text-align:right;">
    <a href="/topic/category/create" >
    ...
    <form class="form-horizontal">
        ...
        <div class="container-fluid">
                ...
                <div class="span12">
                    <table class="table table-striped" id="tableSortable">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX"  id="rowCur{{$category->id}}">
                                <td><a href="/topic/category/edit/{{$category->id}}">{{ $category->id }}</a> <a href="javascript:;" class="bootstrap-tooltip" data-placement="top" data-original-title="{{ $category->name }}"><i class="icon-photon info-circle"></i></a></td>
                                <td><a href="/topic/category/edit/{{$category->id}}">{{ $category->name }}</a></td>
                                <td><a href="/topic/category/edit/{{$category->id}}">{{ $category->created_at }}</a></td>
                                <td class="center">
                                    <a href="/topic/category/edit/{{$category->id}}">{{ $category->updated_at}}</a>
                                </td>
                                <td class="center"> <input type="checkbox" class="uniformCheckbox" name="checkItem[]" value="{{ $category->id }}"></td>
                            </tr>
                            @endforeach
            ...
            <script>
                ...
                function deleteArticle() {
                    ...
                    if (checkedVals.length > 0) {
                        if(confirm('Are you sure, want to delete the selected categories ? ')){
                        var ids = checkedVals.join(",");
                        //alert(ids);return false;
                        $.get("{{ url('/topic/category/delete')}}",
                                {option: ids},
                        function (data) {
            ...
            <div class="dataTables_paginate paging_bootstrap pagination">
                ...
                {!! $categories->appends(Input::get())->render() !!}
            </div>
        </div><!-- end container -->
