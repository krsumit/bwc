...
<div class="main-content">
    ...
    {!! Form::open(array('url'=>'attributes','class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}
    ...
    <div class="container-fluid">
        <div class="form-legend" id="feed-detail">Attribute Details</div>
           ...
           <div id="Simple_Select_Box" class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    {!! Form::select('attribute_type',['' => 'Please Select']+$atributeTypes,old('attribute_type'),
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" id="attribute_name" name="attribute_name" value="{{ old('attribute_name')}}"/>
                </div>
            </div>
        </div>
