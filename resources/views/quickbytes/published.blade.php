    ...
    <div class="panel-content filler">
        ...
        <div class="panel-search container-fluid" style="height: 100px">
            <form class="form-horizontal" action="">
                ...
                <a href="{{url("quickbyte/list/published?channel=").$currentChannelId}}"><button class="btn btn-default" type="button">Reset</button></a>
                @endif
                ...
                <script>
                    ...
                    $(this).find("option:selected").each(function () {
                        ...
                        if ($(this).attr("value").trim().length != 0) {
                            ...
                            window.location = '{{url("quickbyte/list/published")}}' + '?channel=' + $(this).attr("value").trim();
                        }
