...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li class="current">
                <a href="javascript:;">Add Model</a>
            </li>
        </ul>
    </div>            <header>
        <i class="icon-big-notepad"></i>
        <h2><small>Add Model</small></h2>
    </header>
    ...
    {!! Form::open(array('url'=>'brand-models','class'=> 'form-horizontal','id'=>'fileupload','enctype'=>'multipart/form-data')) !!}
    {!! csrf_field() !!}
    ...
    <div class="container-fluid">
        ...
        <div id="Simple_Select_Box" class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    {!! Form::select('brand',['' => 'Please Select']+$brands,old('brand'),
                    ['class' => 'form-control formattedelement','id' =>'brand','class'=>'selectBox formattedelement']) !!}
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <input type="text" id="model_name" name="model_name" required="required"  value="{{ old('model_name')}}"/>
        ...
        <div id="WYSIWYG_Editor_-_Full_Options" class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls elrte-wrapper">
                    <textarea name="description" id="maxi" rows="2" class="auto-resize  formattedtextareat"></textarea>
