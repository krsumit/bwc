...
@section('content')
    ...
    <div class="main-content">
        ...
        {!! Form::open(array('url'=>'tips/','class'=> 'form-horizontal','id'=>'validation_form')) !!}
        {!! csrf_field() !!}
            ...
            <div class="container-fluid" >
                ...
                <div id="add_new">
                    ...
                    <div class="control-group row-fluid">
                        <div class="span12 span-inset">
                            <button type="submit" name="addTip" class="btn btn-success">Add</button><img src="images/photon/preloader/76.gif" alt="loader" style="width:5%; display:none;"/>
                        </div>
                    </div>
                </div>
