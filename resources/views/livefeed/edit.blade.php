...
<div class="main-content">
    ...
    <input type="hidden" name="feed_id" id="artile_id" value="{{$feed->id}}"/>
    ...
    <div class="container-fluid">
        ...
        <div  class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls">
                    <textarea  id="title" name="title" rows="2" class="no-resize  title_range valid">{{$feed->title}}</textarea>
        ...
        <div id="WYSIWYG_Editor_-_Full_Options" class="control-group row-fluid">
            ...
            <div class="span9">
                <div class="controls elrte-wrapper">
                    <textarea name="description" id="maxi" rows="2" class="auto-resize required formattedtextareat">
                        {{$feed->description}}
                    </textarea>
