    ...
    <div class="panel-content filler">
        ...
        <div class="panel-search container-fluid">
            <form class="form-horizontal" method="get" action="">
                ...
                <a href="{{url("article/list/drafts")}}?channel={{$currentChannelId}}"><button class="btn btn-default" type="button">Reset</button></a>
                @endif
                ...
                $("#channel_sel").change(function () {
                    $(this).find("option:selected").each(function () {
                        ...
                        if ($(this).attr("value").trim().length != 0) {
                            ...
                            window.location = '{{url("article/list/drafts")}}' + '?channel=' + $(this).attr("value").trim();
                        }
