...
<div class="panel">
    ...
    <ul class="xbreadcrumbs">
        <li>
            ...
            {!! Form::open(array('url'=>'api/newauthor','class'=> 'form-horizontal')) !!}
            {!! csrf_field() !!}
...
//if($(this).attr("value")=="none")					
                                    ...
                                    <div id="new" class="tab-pane fade entypo ">
                                        <form name="addAuthorForm" method="post">
                                        	 <div class="control-group row-fluid">
                                                <div class="span3">
                                    ...
                                    'author_type'       : $('input[id=author_type]').val(),
                                    'name'              : $('input[name=aName]').val(),
                                    'email'             : $('input[name=Aemail]').val(),
                                    'bio'               : $('input[name=aBio]').val(),
                                    'name'              : $('input[name=Amobile]').val(),
                                    'email'             : $('input[name=Atwitter]').val(),
                                    'column_id'         : $('input[name=selectBoxFilter]').val(),
                                    ...
                                    //method      : 'POST',
                                    url         : '/author/addAuthor', // the url where we want to POST
				...
				<div class="container-fluid">
                        ...
                        <div  class="control-group row-fluid">
							...
							<div class="span9">
                                <div class="controls">
                                    <select name="selectBoxFilter" id="selectBoxFilter20">
  ...
  <!--Topics begin-->
                        <div  class="control-group row-fluid">
                            <div class="span3">
								...
								<img src="images/photon/preloader/76.gif" alt="loader" style="width:20%; display:block; margin-left:15px;"/>
                            </div>
                            <div class="span9">
                                <div class="controls">
...
<!--Select Box with Filter Search begin-->
				...
				<div class="container-fluid">
                        ...
                        <div class="control-group row-fluid" id="Multiple_Select_Box_with_Filter_Search">
                            ...
                            <div class="span9">
                                <div class="controls">
                                    <input type="text" name="add tags" class="required number valid"><span for="add tags" generated="true" class="error" style="display: none;">Please enter a valid text.</span>
                                </div>
                            </div>
							<div class="span12 span-inset">

							  <div style="float:right; width:11%; margin-bottom:5px;"><button type="" class="btn btn-primary" style="display:block;">Attach</button>
                           ...
                           <div class="span12">
                               <table class="table table-striped table-responsive" id="tableSortableResMed">
                                   ...
                                   <tbody>
                                       <tr class="gradeX">
                                           <td>
                                               <img src="images/photon/user1.jpg" alt="user" style="width:40%;" />
                                           </td>
                                           <td>Celebrate 'Dry Holi' to save water for future</td>
                                           <td class="center">JPEG image</td>
                                           <td class="center">PTI</td>
										   <td class="center"><button type="button" class="btn btn-mini btn-danger">Dump</button><img src="images/photon/preloader/76.gif" alt="loader" style="width:20%; display:block; margin-left:15px;"/></td>
                                       </tr>
                                       <tr class="gradeX">
                                           <td>
                                               <img src="images/photon/user2.jpg" alt="user" style="width:40%;" />
                                           </td>
                                           <td>Celebrate 'Dry Holi' to save water for future</td>
                                           <td class="center">JPEG image</td>
                                           <td class="center">PTI</td>
                                       ...
                                       <tr class="gradeX">
                                           <td>
                                               <img src="images/photon/user3.jpg" alt="user" style="width:40%;" />
                                           </td>
                                           <td>Celebrate 'Dry Holi' to save water for future</td>
                                           <td class="center">JPEG image</td>
                                           <td class="center">PTI</td>
                                       ...
                                       <tr class="gradeX">
                                           <td>
                                               <img src="images/photon/user4.jpg" alt="user" style="width:40%;" />
                                           </td>
                                           <td>Celebrate 'Dry Holi' to save water for future</td>
                                           <td class="center">JPEG image</td>
                                           <td class="center">PTI</td>
                                       ...
                                       <tr class="gradeX">
                                           <td>
                                               <img src="images/photon/user5.jpg" alt="user" style="width:40%;" />
                                           </td>
                                           <td>Celebrate 'Dry Holi' to save water for future</td>
                                           <td class="center">JPEG image</td>
                                           <td class="center">PTI</td>
				...
				<div class="control-group row-fluid">
                            <div class="span12 span-inset">
                                 <button type="button" class="btn btn-default">Draft</button><img src="images/photon/preloader/76.gif" alt="loader" style="width:5%; display:none;"/>
                                 <button type="submit" id="pageSubmit" class="btn btn-warning">Submit</button><img src="images/photon/preloader/76.gif" alt="loader" style="width:5%; display:none;"/>
                                 <button type="button" class="btn btn-info">Save</button><img src="images/photon/preloader/76.gif" alt="loader" style="width:5%; display:none;"/>
