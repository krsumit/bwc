    ...
    <div class="panel-content filler">
        ...
        <div class="panel-search container-fluid">
            <form class="form-horizontal" method="get" action="">
                ...
                <a href="{{url("article/list/scheduled")}}?channel={{$currentChannelId}}"><button class="btn btn-default" type="button">Reset</button></a>
                @endif
...
<!--                            <tr class="gradeX">
                            ...
                            <tr class="gradeX" id="rowCur{{$article->article_id}}">
                                ...
                                <td class="center"> <input type="checkbox" class="uniformCheckbox" value="{{ $article->article_id }}" name="checkItem[]">
