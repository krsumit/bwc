...
@section('title', 'Deleted Articles - BWCMS')
...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-header">
            <h1><small>Deleted Articles</small></h1>
        ...
        <div class="panel-search container-fluid">
            <form class="form-horizontal" method="get" action="">
                ...
                <a href="{{url("article/list/deleted")}}?channel={{$currentChannelId}}"><button class="btn btn-default" type="button">Reset</button></a>
                @endif
<!--                    <script>
                    $().ready(function(){
                        var searchTags = [
                ...
                $("#channel_sel").change(function () {
                    $(this).find("option:selected").each(function () {
                        ...
                        if ($(this).attr("value").trim().length != 0) {
                            ...
                            window.location = '{{url("article/list/deleted")}}' + '?channel=' + $(this).attr("value").trim();
                        }
...
<div class="main-content">
    <div class="breadcrumb-container">
        <ul class="xbreadcrumbs">
            ...
            <li class="current">
                <a href="javascript:;">Deleted Articles</a>
            </li>
        </ul>
    </div>           <header>
        <i class="icon-big-notepad"></i>
        <h2><small>Deleted Articles</small></h2>
    </header>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <table class="table table-striped" id="tableSortable">
                        ...
                        <tbody>
<!--                            <tr class="gradeX">
                            <td><a href="create-new-articles.html">234567890987654</a> <a href="javascript:;" class="bootstrap-tooltip" data-placement="top" data-original-title="Assigned to -Sharabani Mukherjee, Assigned by -Hiten Mehta"  style="display:block;"><i class="icon-photon info-circle"></i></a>
                            </td>
                            ...
                            <tr class="gradeX" id="rowCur{{$article->article_id}}">
                                <td><a href="/article/{{ $article->article_id }}">{{ $article->article_id }}</a> <a href="javascript:;" class="bootstrap-tooltip" data-placement="top" data-original-title="Assigned to -{{ $article->name }}, Assigned by -"  style="display:block;"><i class="icon-photon info-circle"></i></a>
                                </td>
        ...
        <div class="control-group row-fluid">
            <div class="span12 span-inset">
                ...
                <button type="button" onclick="publishArticle()" class="btn btn-success">Publish</button><img src="{{ asset('images/photon/preloader/76.gif')}}" alt="loader" style="width:5%; display:none;"/>
                @endif
            </div>
        </div>
    </form>
